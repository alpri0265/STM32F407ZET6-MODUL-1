...
/**
  * @brief This function handles EXTI line[15:10] interrupts (PB12 = MPG_A encoder).
  */
void EXTI15_10_IRQHandler(void)
{
  if (__HAL_GPIO_EXTI_GET_IT(MPG_A_Pin) != 0x00u) {
    HAL_GPIO_EXTI_IRQHandler(MPG_A_Pin);
  }
}

/**
  * @brief This function handles TIM6 global interrupt (1 ms — опитування енкодера).
  */
